...
<html>
  <head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="assts/img/favicon.ico">
  ...
  <body>
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center"><img src="img/avatar-7.jpg" alt="person" class="img-fluid rounded-circle">
            <h2 class="h5">Medical Care Management System</h2>
          </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="addcategory.php"> <i class="icon-form"></i>Add category                             </a></li>
            <!-- <li><a href="additems.php"> <i class="fa fa-bar-chart"></i>Add item                            </a></li> -->
            <li><a href="addmedicals.php"> <i class="fa fa-bar-chart"></i>Add medicals                            </a></li>
            <li><a href="addmedicine.php"> <i class="icon-grid"></i>Add medicin                        </a></li>
    ...
    <div class="page">
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="index.php" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><span>e-Medical</span><strong class="text-primary">Care</strong></div></a></div>
      ...
      <!-- Counts Section -->
        ...
        <a  href="insertcategory.php" class="btn btn-primary fa fa-plus-square"  >
                  Add Category
...
$sd=1;
            while ($f=mysqli_fetch_array($sql,MYSQLI_ASSOC)) {
              # code...
           ?>
              ...
              <tr>
                <td><?php echo $sd++;?></td>
                <td><?php echo $f["categorys"]; ?></td>
                
                
                <td><a onclick="return confirm('Are you sure to delete, all details will be deleted?')" href="php_action/delcat.php?del=<?php echo $f['c_id']; ?>" class="btn btn-outline-danger">Delete</a></td>
              </tr>
             <?php
             echo "";
             }?>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-6 text-right">
              <p>Design by <a href="https://bootstrapious.com" class="external">e-Care</a></p>
